...
module.exports = async function calculateTriage(exchange, targetAsset, input, symbol1, symbol2, symbol3) {
    ...
    let ticker1 = await exchange.fetchTicker(symbol1.symbol);
    let ticker2 = await exchange.fetchTicker(symbol2.symbol);
    let ticker3 = await exchange.fetchTicker(symbol3.symbol);
