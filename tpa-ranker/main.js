...
const optionDefinitions = [
    { name: 'exchange', alias: 'e', type: String, multiple: false, description: 'The exchange to be used. Must be an exchange define in CCXT.\nExample: binance', typeLabel: '[underline]{exchange}' },
    { name: 'target', alias: 't', type: String, multiple: false, description: 'The target asset. Example: BTC', typeLabel: '[underline]{asset}' },
    { name: 'threshold', type: Number, multiple: false, description: 'Display TPA pairs with percentage above threshold', typeLabel: '[underline]{threshold}' },
    // { name: 'verbose', alias: 'v', type: Boolean },
    { name: 'help', alias: 'h', type: Boolean, defaultOption: false, description: 'Print this usage guide.' }
]
